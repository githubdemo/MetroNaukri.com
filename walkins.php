...
{
		$query0 = "SELECT count(*) FROM job_info where iswalkin = 1 and isshow = 1 ";
...
<!-- facebook like button ends -->
		<ul id="menu">
			...
			<li><a href="/walkins.php"><font color="#990000"><strong>Walkins</strong></font></a></li>
		</ul>
	<div >
<?php include ("quote.php")?>
	<h1>Walkins Jobs and Interviews</h1>
<!-- main table starts -->
