...
{
		$query0 = "SELECT count(*) FROM job_info where isgovt = 1 and isshow = 1  ";
...
<!-- facebook like button ends -->
		...
		<ul id="menu">
			...
			<li><a href="/govtjobs.php"><font color="#990000"><strong>Govt. Jobs</strong></font></a></li>
