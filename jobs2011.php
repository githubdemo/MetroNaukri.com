...
{
		$query0 = "SELECT count(*) FROM job_info where isyear2011 = 1 and isshow = 1 ";
...
$query = "SELECT job_id,company, position, lastdate, eventdate, eligibility, comments, location, link
		  FROM job_info 
		  where isyear2011 = 1  and isshow = 1  
...
<!-- facebook like button ends -->
		...
		<ul id="menu">
			...
			<li><a href="/jobs2011.php"><font color="#990000"><strong>Jobs for 2011 Passouts</strong></font></a></li>
