...
{
		$query0 = "SELECT count(*) FROM job_info where isbbamba = 1  and isshow = 1 ";
...
<!-- facebook like button ends -->
		...
		<ul id="menu">
			...
			<li><a href="/bbamba.php"><font color="#990000"><strong>BBA/MBA Jobs</strong></font></a></li>
