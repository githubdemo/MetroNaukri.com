...
{
		$query0 = "SELECT count(*) FROM job_info where isbcamca = 1 and isshow = 1 ";
...
<!-- facebook like button ends -->
		...
		<ul id="menu">
			...
			<li><a href="/bcamca.php"><font color="#990000"><strong>BCA/MCA Jobs</strong></font></a></li>
