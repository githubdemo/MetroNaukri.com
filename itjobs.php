...
{
		$query0 = "SELECT count(*) FROM job_info where isit = 1  and isshow = 1 ";
...
<!-- facebook like button ends -->
		...
		<ul id="menu">
			...
			<li><a href="/itjobs.php"><font color="#990000"><strong>IT Jobs</strong></font></a></li>
